...
// cannot restyle on desktop browsers.
function SelectMenu<T extends string>({ value, options, onChange, ariaLabel }: SelectMenuProps<T>) {
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-11 items-center gap-1.5 rounded-full bg-paper-deep px-4 text-sm font-semibold text-ink-soft"
      >
        {current?.label}
